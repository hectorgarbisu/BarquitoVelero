...
// variable publicas del objeto grafico
    public Double anguloVela = 0.0, anguloTimon=0.0;
    public boolean focusVela=false,focusTimon=false;
    @Override public void paintComponent(Graphics g) {
        super.paintComponent(g);
        Rectangle rect = this.getBounds(); // obtener las dimensiones
        Graphics2D g2 = (Graphics2D)g; // si se desea utilizar la clase Graphics2D
//                 codigo específico con primitivas de dibujo
